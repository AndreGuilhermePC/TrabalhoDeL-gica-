...
valor_total_com_desconto = valor_total_sem_desconto - (valor_total_sem_desconto * (porcentagem_desconto / 100)) #Calcula o valor com desconto

print(f'O valor SEM desconto: R$ {valor_total_sem_desconto:.2f}') #Imprime o valor sem desconto
print(f'O valor COM desconto: R$ {valor_total_com_desconto:.2f}') #Imprime o valor com desconto
